...
function preload(){
  trex_running = loadImage("manwithshield.png");
  trex_collided = loadImage("maskman.png");
  
  backgroundimg = loadImage("sky background.png");
  cloudImage = loadImage("virus.png");
...
function spawnVirus() {
  ...
  if (frameCount % 60 === 0) {
    ...
    switch(rand) {
      ...
      break;
      case 2: cloud.scale=0.5;
      break;
      case 3: cloud.scale=0.3;
      break; 
      case 4: cloud.scale=0.4;
      break; 
     case 5: cloud.scale=0.7;
      break;  
      case 6:cloud.scale=0.2;
      break;         
      default: break;
      }
